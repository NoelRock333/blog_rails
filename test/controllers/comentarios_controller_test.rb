...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { articulo_id: @comentario.articulo_id, cuerpo: @comentario.cuerpo, usuario_id: @comentario.usuario_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { articulo_id: @comentario.articulo_id, cuerpo: @comentario.cuerpo, usuario_id: @comentario.usuario_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
